...
async def start_worker() -> None:
    ...
    while True:
        ...
        try:
            ...
            # awaiting_edit 상태로 전환 — suggested_names + diarization을 DB에 저장
            update_job_result(job_id, speakers=result.get("suggested_names", {}), suggested_speakers=suggested_speakers, diarization=diar_segments or None)
