      ...
      return (
        <div className="flex-1 flex flex-col min-h-0">
          ...
          <div className="flex-1 flex flex-col md:flex-row min-h-0">
            <div className="md:w-[55%] flex flex-col min-h-0 border-b md:border-b-0 md:border-r border-gray-200 dark:border-gray-700 h-1/2 md:h-full">
      ...
      <div className="px-4 py-3 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 flex items-center justify-between flex-shrink-0">
        ...
        {job ? (
          <>
            ...
            {job.status === 'done' && (
              <SeriesSelect jobId={job.id} currentSeriesId={job.series_id} onSeriesChange={() => onJobsChange()} />
            )}
